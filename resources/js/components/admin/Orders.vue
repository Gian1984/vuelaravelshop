                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr v-for="(order,index) in orders" @key="index">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <button  v-if="order.is_delivered == 0"  @click="deliver(index)" class="text-indigo-600 px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 hover:text-indigo-900">{{order.is_delivered == 1? "Yes" : "No"}}</button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
